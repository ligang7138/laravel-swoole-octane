  ...
  <div class="complaint-review">
    ...
    <el-card class="search-card">
      <el-form :model="searchForm" inline>
        ...
        <el-form-item label="联系人">
          <el-input v-model="searchForm.contact_name" placeholder="请输入联系人" clearable style="width: 140px" />
        </el-form-item>
        <el-form-item label="联系电话">
          <el-input v-model="searchForm.contact_phone" placeholder="请输入联系电话" clearable style="width: 140px" />
        </el-form-item>
        <el-form-item label="处理状态">
          <el-select v-model="searchForm.handle_status" placeholder="请选择处理状态" clearable style="width: 140px">
    ...
    <el-card class="table-card">
      ...
      <el-table v-loading="loading" :data="tableData" border stripe>
        ...
        <el-table-column prop="supplier_name" label="被投诉供应商" min-width="150" show-overflow-tooltip />
        ...
        <el-table-column prop="images" label="投诉图片" width="120" align="center">
        ...
        <el-table-column prop="handle_status" label="处理状态" width="100" align="center">
          <template #default="{ row }">
            <el-tag :type="getHandleStatusType(row.handle_status)">
              {{ row.handle_status_text }}
            </el-tag>
          </template>
        </el-table-column>
    ...
    >
      <el-form ref="formRef" :model="formData" :rules="formRules" label-width="120px">
        ...
        <el-form-item v-if="currentRow.images && currentRow.images.length > 0" label="投诉图片">
        ...
        <el-form-item label="处理状态">
          <el-tag :type="getHandleStatusType(currentRow.handle_status)">
            {{ currentRow.handle_status_text }}
          </el-tag>
        </el-form-item>
        <el-form-item v-if="currentRow.handle_result" label="处理结果">
          <el-input :value="currentRow.handle_result" type="textarea" :rows="2" disabled />
        </el-form-item>
        <el-divider />
...
import { getComplaintList, reviewComplaint } from '@/api/modules/approve'
...
async function fetchData() {
  ...
  try {
    const params = {
      ...
      contact_phone: searchForm.contact_phone,
      handle_status: searchForm.handle_status,
...
async function handleSubmit() {
  try {
    ...
    await reviewComplaint(currentRow.value.id, {
